  ...
  <div class="min-h-screen bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                type="email"
                required
                class="block w-full pl-10 pr-3 py-3 border border-gray-600 bg-gray-700 text-white placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      ...
      <div v-else class="text-center space-y-6">
        <div class="bg-green-900/50 border border-green-500 text-green-200 px-6 py-4 rounded-lg">
          ...
          <h3 class="text-lg font-medium text-green-200 mb-2">邮件发送成功！</h3>
        ...
        <div class="space-y-4">
          <button
            ...
            class="w-full py-2 px-4 border border-gray-600 text-gray-300 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
          ...
          <router-link
            to="/login"
            class="block w-full text-center py-2 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
          >
            返回登录
          </router-link>
        </div>
