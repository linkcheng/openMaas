  ...
  <div class="min-h-screen bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        <div class="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              minlength="3"
              maxlength="50"
              class="block w-full px-3 py-3 border border-gray-600 bg-gray-700 text-white placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                minlength="8"
                maxlength="100"
                class="block w-full pr-10 px-3 py-3 border border-gray-600 bg-gray-700 text-white placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div class="mt-2 space-y-1">
              <div class="flex items-center text-xs">
                <span :class="passwordChecks.length ? 'text-green-400' : 'text-gray-500'">
                  ✓ 至少8个字符
                </span>
              </div>
              <div class="flex items-center text-xs">
                <span :class="passwordChecks.uppercase ? 'text-green-400' : 'text-gray-500'">
                  ✓ 包含大写字母
                </span>
              </div>
              <div class="flex items-center text-xs">
                <span :class="passwordChecks.lowercase ? 'text-green-400' : 'text-gray-500'">
                  ✓ 包含小写字母
                </span>
              </div>
              <div class="flex items-center text-xs">
                <span :class="passwordChecks.number ? 'text-green-400' : 'text-gray-500'">
                  ✓ 包含数字
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="请再次输入密码"
            />
            <div v-if="form.confirm_password && form.password !== form.confirm_password" 
        ...
        <!-- 错误提示 -->
        <div v-if="error" class="bg-red-900/50 border border-red-500 text-red-200 px-4 py-3 rounded-lg">
          <div class="flex items-center">
